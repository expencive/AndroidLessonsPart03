...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showNextQuestion();
            ...
            score = savedInstanceState.getInt(KEY_SCORE, score);
            timrLeftInMillis = savedInstanceState.getLong(KEY_MILLIS_LEFT, timrLeftInMillis);
            answered = savedInstanceState.getBoolean(KEY_ANSWERED, answered);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putLong(KEY_MILLIS_LEFT, timrLeftInMillis);
