...
/**
 * Created by Настик on 16.11.2018.
 */
...
public class NotificationHelper extends ContextWrapper {
    ...
    public void createChanels() {
        ...
        chanel2.setLightColor(R.color.colorPrimary);
    ...
    public NotificationCompat.Builder getChanel1Notification(String title, String message) {
